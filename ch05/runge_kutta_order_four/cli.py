...
from runge_kutta_order_four import runge_kutta_order_four
...
def main():
    parser = argparse.ArgumentParser(description=runge_kutta_order_four.__doc__)
    ...
    if args.output_file:
        args.output_file.write("This is the Runge-Kutta method of order four.\n")
        _ = runge_kutta_order_four(
            function=function, a=a, b=b, alpha=alpha, n=n, file=args.output_file, solution=solution
        )
        args.output_file.close()
    else:
        print("This is the Runge-Kutta method of order four.")
        _ = runge_kutta_order_four(
