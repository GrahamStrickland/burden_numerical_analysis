...
def main():
    parser = argparse.ArgumentParser(description=false_position.__doc__)
    ...
    if args.output_file:
        print("")
        args.output_file.write("This is the method of False Position.\n")
        _ = false_position(
        ...
        print("This is the method of False Position.")
        _ = false_position(
            function=function, p_0=p_0, p_1=p_1, tol=tol, n_0=n_0,
